...
build-1500436001:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1500436001-inproc

build-1500436001-inproc: ../release.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1500436001 ../release.cfg
configPkg/compiler.opt: build-1500436001
configPkg/: build-1500436001
